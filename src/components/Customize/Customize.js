...
function Customize() {
    ...
    function handleSubmit(e) {
        ...
        if (user) {
            ...
            axios
                .post(URL, { id: userID, burgerName, ingredients, quantity })
                .then((res) => {
                    setUserData((prev) => {
                        return {
                            userData: {
                                ...prev.userData,
                                customizedBurgers: res.data.custom,
                            },
                        };
                    });
        ...
        <div className='customize1'>
            <div className='burger-customizer'>
                ...
                <form onSubmit={(e) => handleSubmit}>
                    ...
                    <div className='ingredients'>
                        <label>
                            <input
                                type='checkbox'
                                onChange={(e) =>
                                    handleIngredientChange(e, "Cheese")
                                }
                            />
                            Cheese
                        </label>
                        ...
                        <label>
                            <input
                                type='checkbox'
                                onChange={(e) =>
                                    handleIngredientChange(e, "Bacon")
                                }
                            />
                            Bacon
                        </label>
                        ...
                        <label>
                            <input
                                type='checkbox'
                                onChange={(e) =>
                                    handleIngredientChange(e, "Lettuce")
                                }
                            />
                            Lettuce
                        </label>
                        ...
                        <label>
                            <input
                                type='checkbox'
                                onChange={(e) =>
                                    handleIngredientChange(e, "Tomato")
                                }
                            />
                            Tomato
                        </label>
                    ...
                    <button id='customize-button' onClick={handleSubmit}>
                        Let's Brrrgrrr!
                    </button>
                </form>
            </div>
