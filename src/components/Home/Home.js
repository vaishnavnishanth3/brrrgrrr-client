...
export default function Home() {
    ...
    <div>
        <div id="main">
            <div className="greet">
                <h1>Try our new reciepe on <span className="newandhot">Search!</span></h1>
            </div>
            <div className="special-offers">
                ...
                <div className="card">
                    ...
                    <div className="item-image">
                        <img src={burgerImage} alt="burger"></img>
                    </div>
                    <div className="price-details">
                        <div>
                            <p>Buy 3 for <span className="price-number">₹499/-</span></p>
                            <p> Now only at <span className="name">Brrrgrrr</span></p>
                            <Link to="/product"><button className="buy-special">Buy Now!</button></Link>
                        </div>
                    </div>
                </div> 
                <div className="order-now">
                    <h3>Order Now using coupons</h3>
                    <h3>Now available with <img className="bookmyshowlogo" src={bookMyShow} alt='bookmyshow'/> <a className="bookmyshowlink" href="https://in.bookmyshow.com" target="_blank" rel="noreferrer">Bookmyshow!</a></h3>
                </div>
