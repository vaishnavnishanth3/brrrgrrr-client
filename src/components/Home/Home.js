                ...
                <div className='special-offers'>
                    ...
                    <div className='card'>
                        ...
                        <div className='item-image'>
                            <img
                                src='https://th.bing.com/th/id/OIP.foUc1lQc_Z5OvIfsyd8UFgHaGo?w=209&h=187&c=7&r=0&o=5&dpr=1.3&pid=1.7'
                                alt='burger'
                            />
                        </div>
                    ...
                    <div className='order-now'>
                        ...
                        <h3>
                            Now available with
                            <img
                                className='bookmyshowlogo'
                                src={bookMyShow}
                                alt='bookmyshow'
                            />
                            <a
                                className='bookmyshowlink'
                    ...
                    <div className='customize'>
                        <h1>
                            Customize your Own Burger with our available
                            ingredients!
                        </h1>
